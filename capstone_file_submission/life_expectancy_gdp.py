...
# While the US's GDP is much greater than most other countries in this comparison, health outcomes are fairly similar ammong the range of countries.
...
plt.title('Life Expectancy Distributions in Six Countries', fontsize=14)
plt.xlabel('Country', fontsize=14, color='#b1b3b5')
plt.ylabel('Life expectancy at birth (years)', fontsize=14, color='#b1b3b5')
...
#  Zimbabwe has the most growth in life expectancy; the growth of life expectancy in other countries was moderate and fairly similar in shape. 
...
# China and the US have strong GPD growth, while Zimbabwe was the only country with dramatic growth in life expectancy.
# 2011 and 2012 might have had more substantial change in the data.
# Zimbabwe has had the least change in GDP over time.
# GDP growth in Chile, Germany, Mexico and Zimbabwe has not been as significant as either China or the US over the same period.
# From these two charts there doesn't look to be a strong correlation between GDP and life expectancy.
# Perhaps over a certain GDP threshold, life expectancy approaches a range between 70 and 80 years.
...
# Clear subplot labels
for ax in g.axes:
    ax.set_xlabel('')
    ax.set_ylabel('')
# Re-label plots
g.fig.subplots_adjust(top=0.93)
g.fig.suptitle('Scatter Plots of GDP and Life Expectancy, by Year (2000-2015)', fontsize=14)
g.fig.text(.43, -0.01, 'GDP in Trillions of U.S. Dollars', ha='center', va='center', fontsize=14, color='#b1b3b5')
g.fig.text(.01, .5, 'Life expectancy at birth (years)', ha='center', va='center', rotation='vertical', fontsize=14, color='#b1b3b5')
...
# No.
# Year-to-year movement is not very easy to see in small quantities in these charts.
...
g3.fig.suptitle('Line Plots Life Expectancy by Country', fontsize=14)
g3.fig.text(.52, -0.01, 'Year', ha='center', va='center', fontsize=14, color='#b1b3b5')
g3.fig.text(.01, .5, 'Life expectancy at birth (years)', ha='center', va='center', rotation='vertical', fontsize=14, color='#b1b3b5')
...
# Zimbabwe has a different shape to it's line than the other countries.
# Zimbabwe's line also changes the most.
# From roughly 2008 to 2011 Zimbabwe's life expectancy grew the most.
# The life expectancy in the US changed the least over this time period.
# The US is experiencing incremental growth in the life expectancy of it's citizens perhaps because they are nearing  the current limit of modern medicine to affect the average life expectancy.
...
# Re-label plots
g3.fig.subplots_adjust(top=0.90)
g3.fig.suptitle('Line Plots GDP by Country', fontsize=14)
g3.fig.text(.52, -0.01, 'Year', ha='center', va='center', fontsize=14, color='#b1b3b5')
g3.fig.text(.01, .5, 'GDP in Trillions of U.S. Dollars', ha='center', va='center', rotation='vertical', fontsize=14, color='#b1b3b5')
plt.savefig("fig4.png", bbox_inches='tight', pad_inches=0.1)
...
Highest life expectancy = Germany. Lowest life expectancy = Zimbabwe.
...
# The subprime morgage crisis and subsequent market crash had a significant affect on GDP growth in the US. 
# The other five countries in this study show less of a downturn in GDP growth over the same period.
# Life expectancy in the US over the same period continued to rise slightly.
